...
The person submitting the work must **fully understand every line**. You should be able to explain what your change does and why, without AI assistance. If you can't, it isn't ready.

## 3. Review and edit AI output

AI tends toward verbosity, over-engineering, and confident mistakes. Anything AI-generated must be **reviewed, tested, and trimmed by a human** before submission.

## 4. Communicate as a human

Talk to maintainers yourself. Don't paste AI-written walls of text as issue/PR commentary, and don't have a tool "describe its findings" on your behalf. Be concise and direct.

## 5. Keep it focused

One pull request = one concern (a single bug or a single feature). Don't bundle unrelated changes, whitespace reformatting, or comment rewording elsewhere in the codebase. Unfocused PRs will be closed.
